...
struct init{
    ...
    ~init(){
       // std::cerr << "kekkekkekkekkekkekkekkekkekkekkekkekkekkekkekkekkekkekkekkekkekkekkekkekkekkekkekkekkekkekkekkekkekkekkek";
        //vector_digit::get_counts();
    }
} __init__;
...
TEST(correctness, negation_long)
{
    ...
    big_integer b("-10000000000000000000000000000000000000000000000000000");
